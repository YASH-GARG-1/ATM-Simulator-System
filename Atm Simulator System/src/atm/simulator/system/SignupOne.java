...
public class SignupOne extends JFrame implements ActionListener{
    ...
    {    
        ...
        random = Math.abs((rand.nextLong() % 9000L) + 1000L); // storing 4 digit number in random.
        
        // Creating the label for application form no.
...
//        add(next);
    ...
    {
        String formno = "" + random; // converting the long value into string.
    ...
    // Should I comment it?? Till now I dont see the use of min function here.
